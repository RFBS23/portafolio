...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title">Fabrizio B.S.
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home_subtitle">Programador BackEnd</h3>
            <p className="home_description">Soy Estudiante de Ingenieria de Software Con inteligencia Artificial con 2 años de experiencia como <b>DEVELOPER BACK y FRONT END</b></p>
