		...
		<Section classProp="borderBottom">
			<Container spacing={'verticalXXXXLrg'}>
				<SectionTitle
					...
					preTitle="Informativo"
					subTitle="Una búsqueda personal para convertirse en un mejor escritor creativo."
				/>
				<section className={css.projects}>
					{
						articles && articles.length > 0 ? (
							...
							<p>No hay artículos disponibles en este momento.</p> // Contenido alternativo
						)
					}
				</section>
			</Container>
